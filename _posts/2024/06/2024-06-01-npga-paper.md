...
correction_note: "Pinned the paper links to v2, named the GHA + NPHM table row, and restored the authors' motion-prior hypothesis where the summaries had overstated causal evidence. The earlier author correction and reported measurements are unchanged."
image:
...
- The same expression codes fed into the older GHA pipeline **reduced** quality, 26.60 against 26.81. Swapping codes alone was not enough; the paper hypothesizes that the missing NPHM motion prior makes the training signal harder. This is not an ablation of the distillation step alone.
...
**Paper and project**
- NPGA paper: <https://arxiv.org/abs/2405.19331v2> (v2, September 2024)
...
- CC BY 4.0, stated on <https://arxiv.org/abs/2405.19331v2>
