...
tags: [llama-4, mixture-of-experts, moe, transformer, pytorch, llm, deep-learning, from-scratch]
...
- [Understanding Mixture-of-Experts in Large Language Models](https://www.youtube.com/watch?v=...)
- [MoE Tutorial - PyTorch](https://pytorch.org/tutorials/...)
...
- [LLaMA 4 Technical Report](https://arxiv.org/abs/...)
...
- [Efficient Training of Large Language Models with MoE](https://arxiv.org/abs/...)
- [Load Balancing in MoE Models](https://arxiv.org/abs/...)
- [Expert Choice Routing for MoE](https://arxiv.org/abs/...)
...
- [Understanding MoE - Jay Alammar](https://jalammar.github.io/...)
- [LLM from Scratch Course](https://www.youtube.com/...)

**Production Considerations:**
- [Deploying MoE Models at Scale](https://...)
- [MoE Inference Optimization](https://...)
- [Cost Analysis: MoE vs. Dense Models](https://...)
