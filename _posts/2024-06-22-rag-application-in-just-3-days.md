...
description: "Curiosity: How can we build a production-ready RAG application quickly? What's the fastest path from basics to advanced RAG implementation?"
...
## RAG (Retrieval Augmented Generation) has emerged as one of the most popular applications in the LLM field. 

The appeal of this approach lies in its lightweight design and the ability to integrate with base LLMs.

💡 Use this 3-day guide to learn about the evolving landscape of RAG and its latest developments! Invest 2-3 hours per day into the resources.

🥁 Starting from the basics and moving to advanced ideas, you will learn to build and evaluate apps using LangChain. Resources to keep up with the latest research in this field have also been added.

### ⛳ Day 1: Introduction to RAG
- 👉 What is Retrieval Augmented Generation?
- 👉 Core components of RAG: Ingestion, Retrieval, Synthesis
...
- 👉 Advanced RAG optimizations: Self Querying Retrieval, Parent Document 👉 Retriever, Hybrid Search, Compressors, HyDE, and more
- 👉 Build your own RAG system with LangChain and OpenAI
Resources for building advanced RAG applications

### ⛳ Day 3: RAG Evaluation and Challenges
- 👉 Commonly used evaluation metrics in TruEra and RAGas
- 👉 Challenges in RAG and how to address them
